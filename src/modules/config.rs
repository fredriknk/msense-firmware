...
pub const DATASTORE_SIZE: usize = 32; // How many samples can be stored in the channel
pub const ERR_CAP: usize = 5; // How many error messages can be stored in the error log channel
